<html>
  <head>
    <title>Sandwich Size Counts</title>
  </head>
  <body>
<!-- Begin script -->
...
#$query = "SELECT
#     (CASE
#          WHEN order_item.name REGEXP 'LG' THEN 'LG'
#          WHEN order_item.name REGEXP 'KG' THEN 'KG'
#          WHEN order_item.name REGEXP 'HALF' THEN 'HALF' 
#          WHEN order_item.name REGEXP 'KID' THEN 'KID' 
#      END) as SANDWICH, 
...
$query = "call SandSizeSummary('" . $begin_date . " 00:00:00', '" . $end_date . " 23:59:00')";

$result = mysqli_query($conn, $query) or die('Query failed: ' . mysql_error());

# Begin sandwich size counts table
#echo "$query<p>";
echo "
<!--
...
-->
  <table>
    <tr>
      <th align=left>Sandwich Counts</th>
      <th>&nbsp;</th>
      <th>&nbsp;</th>
    </tr>";
